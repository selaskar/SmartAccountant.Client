...
public partial class AdvancedEntry : ContentView
{
    ...
    public static readonly BindableProperty TextProperty = BindableProperty.Create(nameof(Text), typeof(string), typeof(AdvancedEntry),
    ...
    {
        if (bindable is not AdvancedEntry instance)
            return;

        instance.txtEntry.Text = (string)newValue;
    }
    ...
    public static readonly BindableProperty ObjectProperty = BindableProperty.Create(nameof(Object), typeof(INotifyDataErrorInfo), typeof(AdvancedEntry),
        defaultValue: null,
    ...
    public static void ObjectChanged(BindableObject bindable, object oldValue, object newValue)
    {
        ...
        obj.ErrorsChanged += instance.obj_ErrorsChanged;
    ...
    private void obj_ErrorsChanged(object? sender, DataErrorsChangedEventArgs e)
    {
    ...
    public static readonly BindablePropertyKey PropertyNameProperty = BindableProperty.CreateReadOnly(nameof(PropertyName), typeof(string), typeof(AdvancedEntry),
        defaultValue: null,
        defaultBindingMode: BindingMode.OneWay);
    ...
    private void ReadPropertyInfo()
    {
        ...
        {
            txtEntry.MaxLength = stringLengthAttribute.MaximumLength + 1;
        }
    }
}